...
export const TopSellingProducts = () => {
  ...
  const cheapestProducts = getTopSellingProducts();
          ...
          >
            ...
            <div className="flex flex-col flex-1 justify-between">
              ...
              <motion.button
                ...
                className="mt-3 bg-black text-white px-4 py-2 rounded-full text-sm hover:bg-black/90 hover:cursor-pointer transition"
              >
                Add to Cart
              </motion.button>
            </div>
